...
import { Plus, Loader2, FolderPlus, Folder } from "lucide-react";
...
export function CategoryManager() {
  ...
  return (
    <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-purple-950/30 dark:via-slate-900 dark:to-pink-950/30 dark:border-purple-800">
      <CardHeader>
        ...
        <CardDescription className="text-slate-600 dark:text-slate-400">
          Twórz własne kategorie do organizacji pozycji katalogowych. Np. "Hala - Maszyny", "Biuro - Osprzęt".
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="flex gap-3">
          <Input
            ...
            name="new-catalog-category"
            type="text"
            aria-label="Nazwa nowej kategorii katalogu"
        ...
        <div className="space-y-3">
          ...
          {isLoading ? (
            ...
            <div className="max-h-64 overflow-y-auto space-y-2 p-4 bg-white dark:bg-slate-900 rounded-lg border border-purple-200 dark:border-purple-800">
        ...
        {/* Info Note */}
        <div className="text-xs text-slate-500 dark:text-slate-400 bg-purple-50 dark:bg-purple-950/50 p-3 rounded-lg border border-purple-200 dark:border-purple-800">

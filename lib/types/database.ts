...
export interface Project {
  ...
  /** Zestaw Engine v2 (2026-05-04): when TRUE, Smart Mapping Engine virtually expands matching items into
   *  Zestaw assemblies (parent + children with bruzdowanie/cable/box) in PDF, ProjectSummary, offer routes.
   *  Default FALSE — explicit opt-in per project. Manual recipes via addZestawToProject still work regardless. */
...
export interface ProjectItem {
  ...
  /** Zestaw Engine v2 (2026-05-04): when TRUE, this row was generated by Quick Estimate Wizard
   *  and must NEVER be auto-expanded by Smart Mapping Engine. The wizard already produced an
   *  explicit, deterministic line — re-wrapping it as a virtual Zestaw causes double-counted
   *  bruzdowanie / cable. Set by createQuickEstimateProject. */
  is_quick_estimate?: boolean | null;

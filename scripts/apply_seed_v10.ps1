...
$token = [WinCredV10]::GetPassword("Supabase CLI:supabase")
...
$seedPath = Join-Path $PSScriptRoot "..\supabase\migrations\20260310_seed_es_dictionary_v10.sql"
...
Write-Host "`n=== Seed v10 -> TEST ===" -ForegroundColor Cyan
$r1 = Send-SQL -ProjectRef $TEST -Sql $seedSql -Label "SEED v10 (490 entries)"

Write-Host "`n=== Seed v10 -> LIVE ===" -ForegroundColor Cyan
$r2 = Send-SQL -ProjectRef $LIVE -Sql $seedSql -Label "SEED v10 (490 entries)"

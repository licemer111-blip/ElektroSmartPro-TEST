...
$token = [WinCredV8]::GetPassword("Supabase CLI:supabase")
...
$seedPath = Join-Path $PSScriptRoot "..\supabase\migrations\20260308_seed_es_dictionary_v8.sql"
...
Write-Host "`n=== Seed v8 -> TEST ===" -ForegroundColor Cyan
$r1 = Send-SQL -ProjectRef $TEST -Sql $seedSql -Label "SEED v8 (492 entries)"

Write-Host "`n=== Seed v8 -> LIVE ===" -ForegroundColor Cyan
$r2 = Send-SQL -ProjectRef $LIVE -Sql $seedSql -Label "SEED v8 (492 entries)"

...
$token = [WinCredV6]::GetPassword("Supabase CLI:supabase")
...
$seedPath = Join-Path $PSScriptRoot "..\supabase\migrations\20260306_seed_es_dictionary_v6.sql"
...
Write-Host "`n=== Seed v6 -> TEST ===" -ForegroundColor Cyan
$r1 = Send-SQL -ProjectRef $TEST -Sql $seedSql -Label "SEED v6 (643 entries)"

Write-Host "`n=== Seed v6 -> LIVE ===" -ForegroundColor Cyan
$r2 = Send-SQL -ProjectRef $LIVE -Sql $seedSql -Label "SEED v6 (643 entries)"

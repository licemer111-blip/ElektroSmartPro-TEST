...
$token = [WinCredV7]::GetPassword("Supabase CLI:supabase")
...
$seedPath = Join-Path $PSScriptRoot "..\supabase\migrations\20260307_seed_es_dictionary_v7.sql"
...
Write-Host "`n=== Seed v7 -> TEST ===" -ForegroundColor Cyan
$r1 = Send-SQL -ProjectRef $TEST -Sql $seedSql -Label "SEED v7 (649 entries)"

Write-Host "`n=== Seed v7 -> LIVE ===" -ForegroundColor Cyan
$r2 = Send-SQL -ProjectRef $LIVE -Sql $seedSql -Label "SEED v7 (649 entries)"

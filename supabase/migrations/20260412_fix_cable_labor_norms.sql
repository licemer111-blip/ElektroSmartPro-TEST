...
VALUES
  ('KNR 5-08 0201', '5101', '08',
   'Ułożenie przewodu YDYp 3x1,5 mm² p/t w bruździe lub rurce', 'm', 0.13,
   'kablowanie', false,
  ...
  ('KNR 5-08 0202', '5101', '09',
   'Ułożenie przewodu YDYp 3x2,5 mm² p/t w bruździe lub rurce', 'm', 0.16,
   'kablowanie', false,
  ...
  ('KNR 5-08 0203', '5101', '10',
   'Ułożenie przewodu YDYp 5x2,5 mm² p/t w bruździe (3-fazowy)', 'm', 0.20,
   'kablowanie', false,
   '["ydyp 5x2.5","przewód 5x2.5","kabel trójfazowy","3-fazowy przewód","pięciożyłowy","kabel kuchenny trójfazowy"]'),

  ('KNR 5-08 0204', '5101', '11',
   'Ułożenie przewodu YDYp 5x4 mm² p/t lub w rurce (silnik, piekarnik, klimatyzacja)', 'm', 0.24,
   'kablowanie', false,
  ...
  ('KNR 5-08 0205', '5101', '12',
   'Ułożenie przewodu YDYp 5x6 mm² p/t (zasilanie kuchenki elektrycznej / pralki)', 'm', 0.28,
   'kablowanie', false,
...
VALUES
  ('KNR 5-08 0401', '5104', '01',
   'Montaż gniazda pojedynczego 230V/16A z uziemieniem (typ Schuko) — podtynkowe', 'szt', 0.68,
  ...
  ('KNR 5-08 0402', '5104', '02',
   'Montaż gniazda podwójnego 230V/16A z uziemieniem (2x Schuko) — podtynkowe', 'szt', 0.82,
   'osprzet_elektryczny', false,
  ...
  ('KNR 5-08 0404', '5104', '04',
   'Montaż gniazda 230V pojedynczego natynkowego IP20 (przemysłowe, warsztat, garaż)', 'szt', 0.54,
   'osprzet_elektryczny', false,
  ...
  ('KNR 5-08 0407', '5104', '07',
   'Montaż gniazda 3-fazowego CEE 16A 5P (niebieskie, przemysłowe, 400V)', 'szt', 1.18,
  ...
  ('KNR 5-08 0408', '5104', '08',
   'Montaż gniazda 3-fazowego CEE 32A 5P (niebieskie, przemysłowe, 400V)', 'szt', 1.45,
   'osprzet_elektryczny', true,
  ...
  ('KNR 5-08 0411', '5104', '11',
   'Montaż wyłącznika jednobiegunowego (S1) — montaż p/t, podłączenie, regulacja', 'szt', 0.45,
   'osprzet_elektryczny', false,
  ...
  ('KNR 5-08 0412', '5104', '12',
   'Montaż wyłącznika schodowego (S6/S7) — schemat schodowy, 2 lokalizacje', 'szt', 0.54,
   'osprzet_elektryczny', false,
  ...
  ('KNR 5-08 0502', '5105', '02',
   'Montaż oprawy wpuszczanej downlight LED 3–12W do sufitu podwieszanego (oczko)', 'szt', 0.31,
   'oswietlenie', false,
